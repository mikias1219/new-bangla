...
function ChatPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-3 sm:py-4 lg:py-8">
        <div className="bg-white rounded-lg shadow-lg h-[450px] sm:h-[500px] lg:h-[600px] flex flex-col">
          {/* Messages */}
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4">
            ...
            {messages.map((message) => (
              ...
              >
                ...
                <div
                  className={`max-w-[280px] sm:max-w-xs md:max-w-sm lg:max-w-md px-3 py-2 sm:px-4 sm:py-2 rounded-lg ${
          ...
          <div className="border-t border-gray-200 p-3 sm:p-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-3">
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                >
                  {voiceResponseEnabled ? <Volume2 className="w-3 h-3 sm:w-4 sm:h-4" /> : <VolumeX className="w-3 h-3 sm:w-4 sm:h-4" />}
                ...
                {isRecordingVoice ? (
                  <button
                    ...
                    className="p-1.5 sm:p-2 rounded-lg bg-red-100 text-red-600 border border-red-300 animate-pulse"
                  ...
                  <button
                    ...
                    className="p-1.5 sm:p-2 rounded-lg bg-gray-100 text-gray-600 border border-gray-300 hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div className="text-xs text-gray-500 text-center sm:text-right">
                Voice: {voiceResponseEnabled ? 'On' : 'Off'} |
            ...
            <form onSubmit={sendMessage} className="flex gap-2">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full pr-12 px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base disabled:bg-gray-100 disabled:cursor-not-allowed"
                  disabled={loading || isVoiceMode}
                />
                ...
                <button
                  onClick={startVoiceRecording}
                  disabled={loading || isVoiceMode}
                  className={`absolute right-2 sm:right-3 top-1/2 transform -translate-y-1/2 p-1 sm:p-1.5 rounded-full transition-colors ${
                    isRecordingVoice
              ...
              <button
                ...
                className="bg-blue-600 text-white px-3 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1 sm:gap-2 min-w-[60px] sm:min-w-[80px]"
              >
