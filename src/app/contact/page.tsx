      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions or need support? We&apos;d love to hear from you. Get in touch with our team.
          </p>
        </div>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1">support@banglachatpro.com</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1">Dhaka, Bangladesh</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1">24-48 hours</p>
                  <p className="text-sm text-gray-500">Average response time for inquiries</p>
                </div>
              </div>
            </div>
